...
const steps: Step[] = [
  ...
  },
  {
    ...
    description:
      "A equipe responsável avalia o conteúdo, evidências e necessidade de apuração.",
    Icon: Search,
  },
  {
    title: "Podem ser solicitadas informações adicionais",
    description:
    ...
    >
      ...
      <div className="flex max-w-[560px] flex-col gap-4">
        <h2 className="text-h2 text-neutral-50">
          ...
          <br />
          <span className="font-bold text-primary-500">processo</span>
        </h2>
        <p className="text-body leading-[1.5] text-neutral-400">
          Um processo estruturado e sigiloso, do registro do relato ao
          encaminhamento conforme as políticas internas.
        </p>
      </div>
